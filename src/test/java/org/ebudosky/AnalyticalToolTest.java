...
class AnalyticalToolTest {
    ...
    void testParentChildQuestionMatch() {
        ...
        assertEquals("65", tool.executeQuery("D 1 10 P 01.10.2012-31.12.2012"));
    }
    ...
    void testParentGrandchildQuestionHierarchy() {
        ...
        assertEquals("83", tool.executeQuery("D 1.1 8 P 01.10.2012-01.12.2012"));
    ...
    void testChildGrandchildQuestionHierarchy() {
        ...
        assertEquals("83", tool.executeQuery("D 1.1 8.15 P 01.10.2012-01.12.2012"));
    }
    ...
    void testExactDeepestPossibleMatch() {
        ...
        assertEquals("117", tool.executeQuery("D 1.1 5.5.1 P 01.11.2012"));
    }
    ...
    void testGlobalWildcards() {
        ...
        assertEquals("88", tool.executeQuery("D * * P 01.01.2012-31.12.2012"));
    }
